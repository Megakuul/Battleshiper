<script>
  ...
  projects: [
    ...
    {
      name: "Project Basdf asd fasdfasdfasdf asdf asd fasd fsafd ",
      deleted: true,
      initialized: false,
      status: "archived",
      aliases: {
    ...
    },
    {
      ...
      deleted: true,
      initialized: false,
      status: "EXEC FAILED: Ajföalsfjdöla kjfLWWWWWWWWWWWWWWWWWWWWWJLKJLKéJLéKJLéKJéLKJéLKJFéLKEJéLKJFSéLJFéLKEJPIJFPOèSIJFOèPEJFPOSJFéLSKJFéOEJFIèOJOSKFJEIJFOSEJFOSJEFOISJEFOISJEFOIEFJOSEJFOJEFSOISEFJOSWJFREOèSIJEFéOISEJFOIESFJ",
      aliases: {
        alias3: { key: "value3" }
      },
      repository: {
